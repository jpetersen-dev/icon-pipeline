...
for img in "${FILES[@]}"; do
  ...
  # =====================================================================================
  # MODO MULTICOLOR / LAYERS (SVG Separado por Canales)
  # =====================================================================================
  ...
  # =====================================================================================
     ...
     echo "  -> Modo Color: Limpieza de fondo..."
     target_png="output/design/${name}_transparent.png"
     # Solucionado el bug de variables indefinidas. 
     # Ahora hace transparente el fondo tocando la esquina 0,0 y recorta.
     $IMG_TOOL "$img" -alpha set -fuzz 15% -fill none -draw "color 0,0 floodfill" -trim +repage "$target_png"

  # =====================================================================================
  # MODO ESTÁNDAR (Blanco y Negro Vectorial)
  # =====================================================================================
  else
